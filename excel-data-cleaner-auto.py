# This is used for large spreadsheets to copy images listed in an excel refrencing a keyword into a new folder. 
...
# Path of your folder
path = "X:\Matlab"
# Name of file for the Data Spreadsheet
file_name = "\Data_Entry_2017.xlsx"
# Array of list of diseases "Atelectasis","Cardiomegaly" "Effusion", "Infiltration" , "Mass" , "Nodule", "Pneumonia" ,"Pneumothorax" , "Consolidation" , "Edema" , "Emphysema" , "Fibrosis",
#"Pleural_Thickening"
disease = [  "Finding" ]
# Destination Folder
path2 = ""
...
def Seperates(disease):
    path2 = path + "\\" + disease
    # This function seperates the diseases into their classes (folders)
    ...
    for i in range(1,(images.__len__() -1)):
...
for i in range(disease.__len__()):
    Seperates(disease[i])
